    ...
    if request.method == "GET":
        ...
        if user_one.user_password == pwd:
            ...
            if user_one.user_role_id == 1:
                ...
                return redirect(reverse('registration_index'))
...
class Register(views.View):
    ...
    def post(self, request):
        ...
        if f.is_valid():
            ...
            if depart == None:
                depart = ''
            F = UserInfo.objects.create(user_number=number, user_password=password, user_card=card, user_phone=phone,
                                        user_role_id=int(role_id), doctor_belong_id=int(depart))
            F.save()
