...
#     role_name = models.CharField(max_length=50,default=None)
...
#     fk_doctor_message_user = models.ForeignKey('UserInfo', on_delete=models.CASCADE) #关联用户表
#
#
...
#     depar_name = models.CharField(max_length=10,default=None)
...
class UserInfo(models.Model):  # 用户表
    ...
    user_role = models.ForeignKey('Role',on_delete=models.CASCADE,null=True,default=None)
    doctor_belong = models.ForeignKey('Department',on_delete=models.CASCADE,null=True,default=None)
